...
export const HARD_HTML = [
  ...
  {
    question:
      "How do you use the service workers API in JavaScript to create offline experiences for web applications and improve the performance of a webpage?",
    answer: (
      <>
        <p className="simple_answers">
          To use the service workers API in JavaScript to create offline
          experiences for web applications and improve the performance of a
          webpage, you will need to create a service worker using the{" "}
          <code>ServiceWorker()</code> constructor and specify the script file
          in the constructor.
        </p>
        <br />
        <CodeSnippet
